...
class vcard_convert extends Contact_Vcard_Parse
{
    ...
    function toCSV($delm="\t", $add_title=true, $encoding=null)
        ...
        if ($add_title)
        {
            $out .= 'First Name'.$delm.'Last Name'.$delm.$delm.'Nickname'.$delm.'E-mail Address'.$delm.'Email Address'.$delm;
            ...
            $out .= 'Web Page'.$delm.'Web Page 2'.$delm;
            do {
                $out .= 'Group Membership'.$delm;
            } while 
        }
